...
std::string RoverIdentityProvider::identity() {
        ...
        json_object_setstr(identity_data_object, JsonFieldNames::romi_device_type.data(), romi_device_type_.c_str());
        json_object_setstr(identity_data_object, JsonFieldNames::romi_hardware_id.data(), romi_hardware_id_.c_str());
        json_object_setstr(identity_data_object, JsonFieldNames::software_version_current.data(), current_software_version_.c_str());
        json_object_setstr(identity_data_object, JsonFieldNames::software_version_alternate.data(), alternate_software_version_.c_str());
