...
#ifndef __ROMI_EXTERNALCAMERA_H
#define __ROMI_EXTERNALCAMERA_H
...
namespace romi {
        ...
        class ExternalCamera : public ICamera
        {
        public:
                static constexpr const char *ClassName = "external-camera";
                
        protected:
                static constexpr const char *kImagePath = "/tmp/romi.jpg";
        ...
        public:
                ...
                explicit ExternalCamera(const std::string& executable);
                ~ExternalCamera() override = default;
