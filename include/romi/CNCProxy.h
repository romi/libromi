 ...
 */
#ifndef __ROMI_CNC_PROXY_H
#define __ROMI_CNC_PROXY_H

#include <romi/ICNC.h>
#include <romi/IRPCHandler.h>

namespace romi {
        
        class CNCProxy : public ICNC
        {
        protected:
                IRPCHandler *_rpc_handler;
                
        public:
                CNCProxy(IRPCHandler *rpc_handler) : _rpc_handler(rpc_handler) {}
                virtual ~CNCProxy() = default;
